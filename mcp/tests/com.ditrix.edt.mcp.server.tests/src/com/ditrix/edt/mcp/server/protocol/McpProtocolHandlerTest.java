...
public class McpProtocolHandlerTest
{
    ...
    public void testToolsListReportsRealToolTaskPolicies()
    {
        ...
        assertEquals("optional", taskPolicies.get(PrepareTestSessionTool.NAME));
        assertEquals("forbidden", taskPolicies.get(GetTestSessionStatusTool.NAME));
        assertEquals("forbidden", taskPolicies.get(RecycleTestSessionTool.NAME));
