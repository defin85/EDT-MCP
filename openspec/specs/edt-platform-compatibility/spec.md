# Capability: EDT Platform Compatibility

## Purpose

Define the supported EDT Ruby compatibility line, runtime tool expectations, and documentation obligations for compatibility-maintained builds.
